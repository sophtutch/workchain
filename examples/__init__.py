"""workchain examples — realistic workflows demonstrating library features.

Examples:
    customer_onboarding  — Sync + async steps, retry, polling with progress
    ci_cd_pipeline       — 6-step pipeline, multiple async steps, flaky test retry
